...
class _MyMoneyState extends State<MyMoney> {
  ...
  var image = [
    AssetImage("assets/phonepe.png"),
    AssetImage("assets/phonegold.jpg"),
    AssetImage("assets/jiomoney.jpg"),
    AssetImage("assets/freecharge.jpg"),
    AssetImage("assets/airtel.jpg"),
  ];
  var pm = ["Auto Pay", "Reminders"];
  var image2 = [
    AssetImage("assets/AutoPay.jpg"),
    AssetImage("assets/reminders.jpg"),
  ];
  var wm = ["Gold", "Tax Savings\n\tFunds"];
  var image3 = [
    AssetImage("assets/gold.jpg"),
    AssetImage("assets/Tax.jpg"),
  ];
